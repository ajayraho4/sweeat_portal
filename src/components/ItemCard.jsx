...
export default function ItemCard({id, name, price, rating, image, editButtonHandler, deleteButtonHandler}) {
		...
		<Card sx={{ width: 300 }}>
			...
			<CardActions className="flex justify-end px-2 -mt-4">
				<Tooltip title="Edit this item">
					<IconButton onClick={()=>editButtonHandler({id, name, price})}>
				...
				<Tooltip title="Delete this item">
					<IconButton onClick={()=>deleteButtonHandler({id, name, price, rating})} color="error">
...
/*
				<div className="flex text-xs items-center">Available<Switch checked={available} size="small" onChange={handleChange} name="available" /></div>*/