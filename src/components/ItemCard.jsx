...
export default function ItemCard({
  ...
  return (
    <Card
      sx={available ? { width: 300 } : { width: 300, backgroundColor: "#eee" }}
    >
      <CardMedia
        component="img"
        height="80"
      ...
      <CardActions className="flex justify-end px-2 -mt-4">
        <Tooltip title="Edit this item">
          <IconButton
            onClick={() =>
              editButtonHandler({ id, name, price, available, rating })
            }
          >
            <svg
        ...
        <Tooltip title="Delete this item">
          <IconButton
            onClick={() =>
              deleteButtonHandler({ id, name, price, available, rating })
            }
            color="error"
          >
            <svg
