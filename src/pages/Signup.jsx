				...
				<div className='flex justify-center rounded-lg border py-8 w-3/6 mt-5 drop-shadow-md bg-white'>
					<form className='flex flex-col justify-center items-center space-y-3 w-full'>
						<div className='inputBox w-3/4'>
							...
							<input required placeholder='Store Name' onChange={(e)=>setStoreName(e.target.value)} type="text" />
						</div>
						<div className='inputBox w-3/4'>
							<div className='px-2'>
							...
							<input required placeholder='Admin Email' onChange={(e)=>setEmail(e.target.value)} type="email" />
						</div>
						<div className='inputBox w-3/4'>
							<div className='px-2'>
							...
							<input required placeholder='Password' onChange={(e)=>setPasssword(e.target.value)} type="password" />
						</div>
						<div className='inputBox w-3/4'>
							<div className='px-2'>
