  ...
  return (
    <>
      ...
      <div className="hidden md:flex flex-col">
        <header
          className="flex flex-col pt-3 md:pt-6 w-full"
          style={{ backgroundImage: `url("../headerFlip.png")` }}
        >
          <h1 className="flex justify-end w-full text-3xl pr-6 md:text-5xl font-bold mr-7 pl-3 md:pl-8">
            Sweeat
          </h1>
          <h2 className="justify-between flex mt-10 w-72 ml-8">
            <span className="truncate italic">{context.data.tagline}</span>
            <div className="flex">
              <svg
        ...
        <h2 className="flex justify-start text-3xl font-bold w-full -mt-14 pl-4">
          {context.data?.name}
        </h2>
        <section className="pt-8 flex flex-col mt-6 w-full h-auto">
